...
DEFAULT_APP_MEM=64
DEFAULT_APP_CONF=application-production.conf
...
doStart() {
    ...
    RUN_CMD+=(-Dspring.profiles.active=production -Dconfig.file=$APP_HOME/conf/$APP_CONF -Dlogger.file=$APP_HOME/conf/application-logger-production.xml)
